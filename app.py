...
# student2 = Student("Phyllis", "Buisness", 3.8, False)
...
#   def make_chicken(self):
#     print("Makes even better chicken")
#   def make_rice(self):
#     print("Chinese chef makes rice")
# myChef = ChineseChef()
# myChef.make_chicken()

####### PYTHON INTERPRETER #######
# type python3 in terminal to use python in terminal